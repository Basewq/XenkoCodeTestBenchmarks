...
namespace XenkoCodeTestBenchmarks.Graphics
{
    ...
    public struct RasterizerStateDescriptionOrig : IEquatable<RasterizerStateDescriptionOrig>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RasterizerStateDescriptionOrig"/> class.
        /// </summary>
        /// <param name="cullMode">The cull mode.</param>
        public RasterizerStateDescriptionOrig(CullMode cullMode) : this()
        {
            SetDefault();
            CullMode = cullMode;
        }
        ...
        /// </summary>
        public static RasterizerStateDescriptionOrig Default
        {
            get
            {
                var desc = new RasterizerStateDescriptionOrig();
                desc.SetDefault();
                return desc;
            }
        }

        public bool Equals(RasterizerStateDescriptionOrig other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is RasterizerStateDescriptionOrig && Equals((RasterizerStateDescriptionOrig)obj);
        }
        ...
        public static bool operator ==(RasterizerStateDescriptionOrig left, RasterizerStateDescriptionOrig right)
        {
