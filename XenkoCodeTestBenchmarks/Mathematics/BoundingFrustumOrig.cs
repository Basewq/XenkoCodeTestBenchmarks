...
namespace XenkoCodeTestBenchmarks.Mathematics
{
    ...
    /// A bounding frustum.
    /// </summary>
    public struct BoundingFrustumOrig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoundingFrustumOrig"/> struct from a matrix view-projection.
        /// </summary>
        /// <param name="matrix">The matrix view projection.</param>
        public BoundingFrustumOrig(ref Matrix matrix)
        {
            // Left
